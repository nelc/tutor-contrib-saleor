...
hooks.Filters.CONFIG_DEFAULTS.add_items(
    [
        ...
        ("RUN_SALEOR_APP_STRIPE", True),
        ("RUN_SALEOR_APP_DUMMY", True),
        ("SALEOR_APP_STRIPE_IMAGE", "ednxops/tests-nelp:saleor-app-stripe"),
        ("SALEOR_APP_STRIPE_PORT", "18030"),
        ...
        ("SALEOR_APP_DUMMY_IMAGE", "ednxops/tests-nelp:saleor-app-dummy"),
        ("SALEOR_APP_DUMMY_PORT", "18040"),
        ("SALEOR_DUMMY_HOST", "saleor-dummy.{{ LMS_HOST }}"),
